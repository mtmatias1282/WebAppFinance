...
<head>
    ...
    <title>Category Transactions</title>
...
<div class="container">
    <header class="header">
        <h1 class="category-name">${category.getName()}</h1>
        <a href="${pageContext.request.contextPath}/AccountingController?ruta=showCategories" class="exit-button">
    ...
    <main class="main-content">
        <div class="filter-section">
            ...
            <div class="date-filter-component">
                <form method="get" action="${pageContext.request.contextPath}/AccountingController?ruta=showCategoriesTransactions&category=${category.getName()}">
                    ...
                    <input type="hidden" name="ruta" value="showCategoriesTransactions">
                    <input type="hidden" name="category" value="${category.getName()}">
                    <button type="submit" class="filter-button">Filter by Date</button>
                </form>
            </div>
        </div>
