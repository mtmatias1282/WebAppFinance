...
<div class="income-container">
    <div class="income-content">
        <header class="header">
            ...
            <p>Please provide any specific details or notes related to the income</p>
        </header>
        <main class="main-content">
            ...
            <form class="income-form" action="${pageContext.request.contextPath}/AccountingController?ruta=addIncome" method="post">
                <input type="hidden" name="accountId" value="${account.id}">
                <div class="form-group">
                    <div class="form-label">
                        <h3>Select Category</h3>
                        <p>Select the category related to the income</p>
                    </div>
                    <div class="form-input">
                        <div class="amount-input">
                            <select class="select-category" name="incomeCategoryId" required>
                ...
                <div class="form-group">
                    <div class="form-label">
                        <h3>Concept</h3>
                        <p>Please provide any additional information or instructions related to the income</p>
                    </div>
                    <div class="form-input">
                ...
                <div class="form-actions">
                    <hr>
                    <button class="submit-button" type="submit">Add Income</button>
                </div>
            </form>
        </main>
    </div>
